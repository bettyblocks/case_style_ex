    ...
    {:ok,
     %CaseStyle{
       ...
       tokens: [
         ...
         %CaseStyle.Tokens.Literal{value: ~c"_"},
         %CaseStyle.Tokens.Spacing{},
         %CaseStyle.Tokens.AfterSpacingChar{value: ~c"t"},
         %CaseStyle.Tokens.Char{value: ~c"e"},
         %CaseStyle.Tokens.Char{value: ~c"s"},
         %CaseStyle.Tokens.Char{value: ~c"t"},
         %CaseStyle.Tokens.Char{value: ~c"i"},
         %CaseStyle.Tokens.Char{value: ~c"n"},
         %CaseStyle.Tokens.Char{value: ~c"g"},
         %CaseStyle.Tokens.Literal{value: ~c"_"},
         %CaseStyle.Tokens.Literal{value: ~c"_"},
         %CaseStyle.Tokens.Literal{value: ~c"!"},
